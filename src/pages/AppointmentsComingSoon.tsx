...
export default function AppointmentsComingSoon() {
      ...
      <div className="max-w-2xl mx-auto px-4 text-center space-y-8">
        <div className="space-y-4">
          <div className="flex justify-center">
            <div className="relative">
              ...
              <Calendar className="h-24 w-24 text-primary relative animate-pulse" />
            </div>
          </div>
        ...
        <div className="space-y-4">
          <p className="text-base md:text-lg text-foreground/80 max-w-md mx-auto">
            We're creating a seamless appointment booking experience with nearby doctor discovery, real-time availability, and instant confirmations. Coming very soon!
          </p>
